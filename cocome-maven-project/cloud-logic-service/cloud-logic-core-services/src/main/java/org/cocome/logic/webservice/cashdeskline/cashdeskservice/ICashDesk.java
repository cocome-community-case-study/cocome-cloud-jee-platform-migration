package org.cocome.logic.webservice.cashdeskline.cashdeskservice;
...
public interface ICashDesk {
     ...
     *
     * @param cashDeskName the name of the cash desk to check
     * @param storeID      the store ID of the store in which the cash desk is located
     * @return {@code true} if cash desk is in express mode, {@code false} otherwise
     * @throws Exception
     */
    boolean isInExpressMode(@XmlElement(required = true) @WebParam(name = "cashDeskName") String cashDeskName,
     ...
     *
     * @return Set of model classes with changed content.
     * @throws UnhandledException
     * @throws IllegalCashDeskStateException
     * @throws Exception
     */
    Set<Class<?>> startSale(@XmlElement(required = true) @WebParam(name = "cashDeskName") String cashDeskName,
     ...
     * @throws Exception
     */
    Set<Class<?>> finishSale(@XmlElement(required = true) @WebParam(name = "cashDeskName") String cashDeskName,
     ...
     *
     * @param cashDeskName the name of the cash desk to select payment for
     * @param storeID      the storeID of the cash desk's store
     * @param mode         the payment mode as specified in {@code PaymentMode}
     * @return Set of model classes with changed content.
     * @throws UnhandledException
     * @throws IllegalCashDeskStateException
     * @throws IllegalInputException
     */
    Set<Class<?>> selectPaymentMode(@XmlElement(required = true) @WebParam(name = "cashDeskName") String cashDeskName,
     ...
     *
     * @param amount the cash amount payed by the customer
     * @return Set of model classes with changed content.
     * @throws UnhandledException
     * @throws IllegalCashDeskStateException
     */
    Set<Class<?>> startCashPayment(@XmlElement(required = true) @WebParam(name = "cashDeskName") String cashDeskName,
                                   @XmlElement(required = true) @WebParam(name = "storeID") long storeID,
     ...
     * @throws IllegalCashDeskStateException
     */
    Set<Class<?>> finishCashPayment(@XmlElement(required = true) @WebParam(name = "cashDeskName") String cashDeskName,
                                    @XmlElement(required = true) @WebParam(name = "storeID") long storeID) throws IllegalCashDeskStateException, ProductOutOfStockException, UnhandledException;
     ...
     * @throws IllegalCashDeskStateException
     */
    Set<Class<?>> startCreditCardPayment(@XmlElement(required = true) @WebParam(name = "cashDeskName") String cashDeskName,
                                         @XmlElement(required = true) @WebParam(name = "storeID") long storeID,
     ...
     * @throws IllegalCashDeskStateException
     */
    Set<Class<?>> finishCreditCardPayment(@XmlElement(required = true) @WebParam(name = "cashDeskName") String cashDeskName,
                                          @XmlElement(required = true) @WebParam(name = "storeID") long storeID,
    ...
    //
    Set<Class<?>> enableExpressMode(@XmlElement(required = true) @WebParam(name = "cashDeskName") String cashDeskName,
                                    @XmlElement(required = true) @WebParam(name = "storeID") long storeID) throws UnhandledException;

    //
    // The express mode can be disabled in all states.
    //
    Set<Class<?>> disableExpressMode(@XmlElement(required = true) @WebParam(name = "cashDeskName") String cashDeskName,
                                     @XmlElement(required = true) @WebParam(name = "storeID") long storeID) throws UnhandledException;
     ...
     * @throws ProductOutOfStockException
     */
    Set<Class<?>> addItemToSale(@XmlElement(required = true) @WebParam(name = "cashDeskName") String cashDeskName,
                                @XmlElement(required = true) @WebParam(name = "storeID") long storeID,
