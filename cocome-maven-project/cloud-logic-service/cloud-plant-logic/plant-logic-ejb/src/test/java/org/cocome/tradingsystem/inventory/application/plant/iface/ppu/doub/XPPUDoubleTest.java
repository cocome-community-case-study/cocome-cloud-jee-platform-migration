...
/**
 * Runs interface tests on the double or real xPPU device
 *
...
public class XPPUDoubleTest {
    ...
    // Given
    private static IPUInterface ppuDevice;
    ...
    public static void initDevice() {
        if (TestUtils.REAL_XPPU_ENDPOINT.isEmpty()) {
            ...
            ppuDevice = JAXRSClientFactory.create(TestUtils.REAL_XPPU_ENDPOINT, IPUInterface.class,
    ...
    private boolean containsTerminationElement(final Instant startTime,
        ...
        //Emergency events
        return filteredHistory.stream().anyMatch(e -> {
            //Emergency events
