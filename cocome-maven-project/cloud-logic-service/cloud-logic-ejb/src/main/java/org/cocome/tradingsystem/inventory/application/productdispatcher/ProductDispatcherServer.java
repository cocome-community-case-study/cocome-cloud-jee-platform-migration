...
//	private IPersistenceLocal persistence;
	...
	@EJB
	IStoreInventoryManagerLocal sourceStore;
	...
	public ProductAmountTO[] dispatchProductsFromOtherStores(
		...
		try {
			...
			//
			final Store callingStore = storeQuery.queryStoreById(callingStoreId);
	 ...
	 */
	private void __flushStoreDatabases(final Collection<Store> stores) {
