...
public class EntityGenerator {
	...
	List<ITradingEnterprise> createEnterprises(final int count) {
		return _generateEntities(count, new Factory<ITradingEnterprise>() {
			@Override
			public ITradingEnterprise newEntity(final int index) {
				final ITradingEnterprise enterprise = new ITradingEnterprise();
	...
	List<OrderEntry> createOrderEntries(final int count) {
		return _generateEntities(count, new Factory<OrderEntry>() {
			@Override
			public OrderEntry newEntity(final int index) {
