 ...
 */
@XmlType(name="ProductMovementTO", namespace="http://store.application.inventory.tradingsystem.cocome.org/")
@XmlRootElement(name="ProductMovementTO")
...
public class ProductMovementTO implements Serializable {
	...
	@XmlElement(name="originStore", required=true)
	private StoreTO __originStore;

	@XmlElement(name="destinationStore", required=true)
	private StoreTO __destinationStore;

	@XmlElementWrapper(name="productAmounts", required=true)
