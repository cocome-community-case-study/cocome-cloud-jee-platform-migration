 ...
 */
@XmlType(name="ComplexOrderTO", namespace="http://store.application.inventory.tradingsystem.cocome.org/")
...
public class ComplexOrderTO extends OrderTO {
	...
	private List<ComplexOrderEntryTO> __orderEntries = new LinkedList<>();
