...
public interface IStoreQuery {
     ...
     * @param location store location, may contain wildcard characters and may be empty.
     * @return {@link IStore} entity or {@code null} if there is no store with
     ...
     * @return {@link IStore} entity
     * @throws NotInDatabaseException if a store with the given id could not be found
     */
     ...
     *
     * @param productId unique identifier of a {@link IProduct} entity
     * @return {@link IProduct} entity
     * @throws NotInDatabaseException if a product with the given id could not be found
     */
     ...
     *
     * @param barcode barcode of the product to find
     * @return {@link IProduct} entity with the specified barcode, or {@code null} if there is no such product.
     */
     ...
     *
     * @param orderId unique identifier of a {@link IProductOrder} entity
     * @return An instance of {@link IProductOrder} with the specified id.
     * @throws NotInDatabaseException if a product order with the given id could not be found
     */
     ...
     *
     * @param storeId unique identifier of a {@link IStore} entity
     * @return A collection of products carried by the given store.
     */
     ...
     *
     * @param storeId unique identifier of a {@link IStore} entity
     * @return A collection of outstanding product orders in the specified store.
     */
     ...
     *
     * @param storeId unique identifier of a {@link IStore} entity
     * @return A collection of product orders in the specified store.
     */
     ...
     *
     * @param storeId        unique identifier of a {@link IStore} entity
     * @param productBarcode barcode of the required product
     * @param amount         amount ordered of the product in the required order
     * @return The required product order in the specified store.
     * @throws NotInDatabaseException if no order with the given information can be found
     */
     ...
     *
     * @param storeId unique identifier of a {@link IStore} entity
     * @return A collection of {@link IStockItem} entities objects representing
     ...
     *
     * @param storeId    unique identifier of a {@link IStore} entity
     * @param productIds {@link IProduct} entity identifiers to look up in the stock
