 ...
 */
public interface IProductionOrderEntry extends IIdentifiable {
     ...
     */
    Collection<ICustomProductParameterValue> getParameterValues();

    /**
     * @param parameterValues the parameter values
     */
    void setParameterValues(Collection<ICustomProductParameterValue> parameterValues);
