 ...
 */
@Local
public interface ICashDeskModel {

    /**
     * Sets the name on this cash desk.
     *
     * @param cashDeskName the new name
     */
    void setName(String cashDeskName);
     ...
     */
    void startSale() throws IllegalCashDeskStateException;
     ...
     */
    void finishSale() throws IllegalCashDeskStateException;
     ...
     *                                       does not permit this action
     */
    void selectPaymentMode(PaymentMode mode) throws IllegalCashDeskStateException;
     ...
     *                                       does not permit this action
     */
    void startCashPayment(double amount) throws IllegalCashDeskStateException;
     ...
     *                                       does not permit this action
     */
    void finishCashPayment() throws IllegalCashDeskStateException;

    /**
     * Starts the credit card payment process with the entered credit card info.
     *
     * @param cardInfo the given credit card info
     * @throws IllegalCashDeskStateException if the current cash desk state
     *                                       does not permit this action
     */
    void startCreditCardPayment(String cardInfo) throws IllegalCashDeskStateException;
     ...
     * and has to be valid.
     *
     * @param pin the credit card pin
     * @throws IllegalCashDeskStateException if the current cash desk state
     *                                       does not permit this action
     */
    void finishCreditCardPayment(int pin) throws IllegalCashDeskStateException;
