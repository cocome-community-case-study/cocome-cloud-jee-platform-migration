...
public class DummyAuthenticator implements IAuthenticator {
    ...
    private void createDummyUsers() {
        ...
        IPermission plantPermission = new DummyPermission("plant manager");
        ...
        ICredential plantCredentials = new PlainCredential("plant");
        ...
        admin.addPermission(plantPermission);
        ...
        IUser plantManager = new DummyUser("plantmanager", plantCredentials);
        plantManager.addPermission(plantPermission);
        ...
        users.put(plantManager.getUsername(), plantManager);
    ...
    public boolean checkHasPermission(IUser user, IPermission permission) {
        ...
        if (permission != null) {
            ...
            return storedUser != null && storedUser.hasPermission(permission);
        }
        return false;
    }
