...
#--------------------------------------------------------------------------------------------------------------------------------------
#Please give the exact path to your file or folder!

cocome_adapter_settings="/This are the cocome ADPTER Setting    /settings.xml"
cocome_adapter_pom="/This is the ADAPTER pom    /pom.xml"

cocome_settings="/This are the CoCoME Settings    /settings.xml"
cocome_pom="/This is the CoCoME pom     /pom.xml"

glassfish_home="/path to glassfish     /glassfish/bin"
glassfish_domain="/path to glassfish domains    /glassfish/domains"



cocome_cli="/path to CoCoME   /cocome-maven-project/cloud-cli-frontend/"
