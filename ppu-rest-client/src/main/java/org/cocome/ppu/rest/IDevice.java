...
public interface IDevice {
	 ...
	 * 
	 * @param name
	 *            the module name. This is usually an "/"-separated element of
	 ...
	 * 
	 * @param timestamp
	 *            the time stamp used to filter the history
	 ...
	 * 
	 * @param executionid
	 *            the execution id of the target operation
	...
	@Produces({ MediaType.APPLICATION_JSON, MediaType.TEXT_PLAIN })
	@Path("/halt")
	HistoryEntry haltOperation(@QueryParam("executionid") String executionid);
	 ...
	 * 
	 * @param operationids
	 *            a semicolon (;) separated list of operation ids
	 * @return the new history entry resulting from this operation
	 */
	@POST
	@Produces({ MediaType.APPLICATION_JSON, MediaType.TEXT_PLAIN })
