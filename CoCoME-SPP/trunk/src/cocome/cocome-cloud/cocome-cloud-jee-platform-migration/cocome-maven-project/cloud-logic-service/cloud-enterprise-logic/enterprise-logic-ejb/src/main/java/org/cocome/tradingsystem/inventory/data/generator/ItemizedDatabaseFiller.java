 ...
 */
@Singleton
public class ItemizedDatabaseFiller {
	...
	public void fillDatabase(int stockItemCount, int cashDesksPerStore, String dirString) 
...
//		final int cashDesksPerStore = DatabaseFiller.getCashDesksPerStore(args, 1);
		File outputDir = DatabaseFiller.getOutputDir(dirString);
